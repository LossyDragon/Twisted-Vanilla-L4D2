...
void HurtEntity(int victim, int client, int type, float damage)
{
	...
	switch( type )
	{
		case WEAPON_BASEBALL:		dmg = DMG_CLUB;
		case WEAPON_CRICKET:		dmg = DMG_CLUB;
		case WEAPON_CROWBAR:		dmg = DMG_SLASH;
		case WEAPON_GUITAR:			dmg = DMG_CLUB;
		case WEAPON_FIREAXE:		dmg = DMG_SLASH;
		case WEAPON_FRYING:			dmg = DMG_CLUB;
		case WEAPON_GOLFCLUB:		dmg = DMG_CLUB;
		case WEAPON_KATANA:			dmg = DMG_SLASH;
		case WEAPON_KNIFE:			dmg = DMG_SLASH;
		case WEAPON_MACHETE:		dmg = DMG_SLASH;
		case WEAPON_TONFA:			dmg = DMG_CLUB;
		case WEAPON_PITCHFORK:		dmg = DMG_SLASH;
		case WEAPON_SHOVEL:			dmg = DMG_CLUB;
		case WEAPON_SHIELD:			dmg = DMG_CLUB;	
		default:					dmg = DMG_CLUB|DMG_SLASH;
	}
