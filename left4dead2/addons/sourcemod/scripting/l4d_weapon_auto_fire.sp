...
#define L4D1_WEPID_PUMPSHOTGUN        3
#define L4D1_WEPID_AUTOSHOTGUN        4
...
static ConVar g_hCvar_MountedGunRelease;
...
static bool   g_bCvar_MountedGunRelease;
...
static bool   gc_bUsingMountedWeapon[MAXPLAYERS+1];
...
public void OnPluginStart()
{
    ...
    g_hCvar_WeaponSwitch               = CreateConVar("l4d_weapon_auto_fire_weapon_switch", "1", "Enable/Disable auto fire on weapon switch.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_MountedGunRelease          = CreateConVar("l4d_weapon_auto_fire_mounted_gun_release", "1", "Enable/Disable auto fire on minigun/50 cal release.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_ShotgunReloadEmpty         = CreateConVar("l4d_weapon_auto_fire_shotgun_reload_empty", "1", "Enable/Disable auto shotgun reload when the ammo clip is empty.\n0 = Disable, 1 = Enable, 2 = Enable but forces full reload.", CVAR_FLAGS, true, 0.0, true, 2.0);
    g_hCvar_Pistol                     = CreateConVar("l4d_weapon_auto_fire_pistol", "1", "Enable/Disable auto fire for Pistol.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    g_hCvar_PumpShotgun                = CreateConVar("l4d_weapon_auto_fire_pumpshotgun", "1", "Enable/Disable auto fire for Pump Shotgun.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_PumpShotgun_Frame          = CreateConVar("l4d_weapon_auto_fire_pumpshotgun_frame", "0", "How many frames must wait to enable auto fire for Pump Shotgun.\n0 = Instantly on \"weapon_fire\".", CVAR_FLAGS, true, 0.0);
    g_hCvar_AutoShotgun                = CreateConVar("l4d_weapon_auto_fire_autoshotgun", "1", "Enable/Disable auto fire for Auto Shotgun.\nAlready has auto fire on vanilla.\nEnabling makes it fire faster.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_AutoShotgun_Frame          = CreateConVar("l4d_weapon_auto_fire_autoshotgun_frame", "0", "How many frames must wait to enable auto fire for Auto Shotgun.\n0 = Instantly on \"weapon_fire\".", CVAR_FLAGS, true, 0.0);
    g_hCvar_Hunting_Rifle              = CreateConVar("l4d_weapon_auto_fire_hunting_rifle", "1", "Enable/Disable auto fire for Hunting Rifle.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    if (g_bL4D2)
    {
        g_hCvar_Pistol_Magnum          = CreateConVar("l4d_weapon_auto_fire_pistol_magnum", "1", "Enable/Disable auto fire for Pistol Magnum.\nL4D2 only.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
        ...
        g_hCvar_Shotgun_Chrome         = CreateConVar("l4d_weapon_auto_fire_shotgun_chrome", "1", "Enable/Disable auto fire for Chrome Shotgun.\nL4D2 only.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
        ...
        g_hCvar_Shotgun_Spas           = CreateConVar("l4d_weapon_auto_fire_shotgun_spas", "1", "Enable/Disable auto fire for Spas Shotgun.\nL4D2 only.\nAlready has auto fire on vanilla.\nEnabling makes it fire faster.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
        ...
        g_hCvar_Sniper_Military        = CreateConVar("l4d_weapon_auto_fire_sniper_military", "1", "Enable/Disable auto fire for Military Sniper.\nL4D2 only.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
        ...
        g_hCvar_Sniper_Scout           = CreateConVar("l4d_weapon_auto_fire_sniper_scout", "1", "Enable/Disable auto fire for Scout Sniper.\nL4D2 only.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
        ...
        g_hCvar_Sniper_AWP             = CreateConVar("l4d_weapon_auto_fire_sniper_awp", "1", "Enable/Disable auto fire for AWP Sniper.\nL4D2 only.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
        ...
        g_hCvar_Grenade_Launcher       = CreateConVar("l4d_weapon_auto_fire_grenade_launcher", "1", "Enable/Disable auto fire for Grenade Launcher.\nL4D2 only.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    g_hCvar_MountedGunRelease.AddChangeHook(Event_ConVarChanged);
...
public void GetCvars()
{
    ...
    g_bCvar_MountedGunRelease = g_hCvar_MountedGunRelease.BoolValue;
...
public void LateLoad()
{
    ...
    {
        if (HasEntProp(entity, Prop_Send, "m_heat"))
...
public void OnClientDisconnect(int client)
{
    ...
    gc_bUsingMountedWeapon[client] = false;
...
public void OnUsePost(int entity, int activator, int caller, UseType type, float value)
{
    ...
    gc_bUsingMountedWeapon[client] = true;
}
...
{
    if (!gc_bUsingMountedWeapon[client])
    {
        gc_bWeaponSwitched[client] = false;
        gc_bWeaponReloadShotgun[client] = false;
    }
...
public Action OnPlayerRunCmd(int client, int &buttons, int &impulse, float vel[3], float angles[3], int &weapon)
{
    ...
    if (gc_bUsingMountedWeapon[client])
    {
        int usingMountedWeapon = GetEntProp(client, Prop_Send, "m_usingMountedWeapon");

        if (usingMountedWeapon == 1)
            return Plugin_Continue;
...
public Action CmdPrintCvars(int client, int args)
{
    ...
    PrintToConsole(client, "l4d_weapon_auto_fire_mounted_gun_release : %b (%s)", g_bCvar_MountedGunRelease, g_bCvar_MountedGunRelease ? "true" : "false");
    ...
    PrintToConsole(client, "l4d_weapon_auto_fire_pistol_frame : %i (%s)", g_iCvar_Pistol_Frame, g_bCvar_Pistol ? "true" : "false");
    ...
    PrintToConsole(client, "l4d_weapon_auto_fire_pumpshotgun : %b (%s)", g_bCvar_PumpShotgun, g_bCvar_PumpShotgun ? "true" : "false");
    PrintToConsole(client, "l4d_weapon_auto_fire_pumpshotgun_frame : %i (%s)", g_iCvar_PumpShotgun_Frame, g_bCvar_PumpShotgun_Frame ? "true" : "false");
    ...
    PrintToConsole(client, "l4d_weapon_auto_fire_autoshotgun : %b (%s)", g_bCvar_AutoShotgun, g_bCvar_AutoShotgun ? "true" : "false");
    PrintToConsole(client, "l4d_weapon_auto_fire_autoshotgun_frame : %i (%s)", g_iCvar_AutoShotgun_Frame, g_bCvar_AutoShotgun_Frame ? "true" : "false");
