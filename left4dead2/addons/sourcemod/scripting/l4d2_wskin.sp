...
public int HandleWeaponMenu(Menu menu, MenuAction action, int param1, int param2)
{
    switch (action)
    {
...
public int HandleWeaponSkinMenu(Menu menu, MenuAction action, int param1, int param2)
{
    switch (action)
    {
        case MenuAction_Select:
