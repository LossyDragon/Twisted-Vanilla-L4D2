...
void Event_EntityShoved(Event event, const char[] name, bool dontBroadcast)
{
    ...
    {
        case TYPE_GNOME: SDKHooks_TakeDamage(target, client, client, float(g_iCvar_GnomeDamage), g_iCvar_GnomeDamageType, activeWeapon);
        case TYPE_COLA: SDKHooks_TakeDamage(target, client, client, float(g_iCvar_ColaDamage), g_iCvar_ColaDamageType, activeWeapon);
    }
}
