...
int g_iColaCount, g_iCola[MAXPLAYERS+1], g_iColas[MAX_COLAS][2], g_iCvarGlow, g_iCvarGlowCol, g_iCvarFull, g_iCvarHeal, g_iCvarMaxM, g_iCvarRandom, g_iCvarSafe, g_iCvarTemp, g_iPlayerSpawn, g_iRoundStart;
...
void GetCvars()
{
	...
	g_fCvarMaxT = g_hCvarMaxT.FloatValue + 0.1;
