...
public void OnPluginStart()
{
	...
	AmmoPackStart = CreateConVar("l4d_give_ammo_pack", "1" , "Give an ammo pack at round start for survivors? 1: Yes. 0: No.", CVAR_FLAGS, true, 0.0, true, 1.0);
...
public Action Join_Survivor(int client, int args)
{
	...
	//}
	/*else if*/ if (CountAvailableBots(TEAM_SURVIVOR) > 0)
	{
		Join_Survivor2(client, 0);
	}
