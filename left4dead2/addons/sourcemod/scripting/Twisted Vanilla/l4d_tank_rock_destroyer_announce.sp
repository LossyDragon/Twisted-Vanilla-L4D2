...
public void OnPluginStart()
{
    ...
    g_hCvar_Enabled = CreateConVar("l4d_tank_rock_destroyer_announce_enabled", "1", "Enables/Disables the plugin. 0 = Plugin OFF, 1 = Plugin ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    // Admin Commands
    RegAdminCmd("sm_l4d_tank_rock_destroyer_announce_print_cvars", AdmCmdPrintCvars, ADMFLAG_ROOT, "Prints the plugin related cvars and their respective values to the console.");
}
...
Action AdmCmdPrintCvars(int client, int args)
{
    ...
    PrintToConsole(client, "l4d_tank_rock_destroyer_announce_enabled : %b (%s)", g_bCvar_Enabled, g_bCvar_Enabled ? "true" : "false");
