...
static ConVar g_hCvar_LaughChance;
...
static int    g_iCvar_LaughChance;

// ====================================================================================================
// entity - Plugin Variables
// ====================================================================================================
static bool   ge_bOnTakeDamageAlivePostHooked[MAXENTITIES+1];

// ====================================================================================================
// ArrayList - Plugin Variables
// ====================================================================================================
static ArrayList g_alBillNiceShot;
static ArrayList g_alFrancisNiceShot;
static ArrayList g_alLouisNiceShot;
static ArrayList g_alZoeyNiceShot;
static ArrayList g_alCoachNiceShot;
static ArrayList g_alEllisNiceShot;
static ArrayList g_alNickNiceShot;
static ArrayList g_alRochelleNiceShot;
static ArrayList g_alBillLaugh;
static ArrayList g_alFrancisLaugh;
static ArrayList g_alLouisLaugh;
static ArrayList g_alZoeyLaugh;
static ArrayList g_alCoachLaugh;
static ArrayList g_alEllisLaugh;
static ArrayList g_alNickLaugh;
static ArrayList g_alRochelleLaugh;
...
public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
    ...
    g_alBillNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alFrancisNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alLouisNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alZoeyNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alCoachNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alEllisNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alNickNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alRochelleNiceShot = new ArrayList(PLATFORM_MAX_PATH);
    g_alBillLaugh = new ArrayList(PLATFORM_MAX_PATH);
    g_alFrancisLaugh = new ArrayList(PLATFORM_MAX_PATH);
    g_alLouisLaugh = new ArrayList(PLATFORM_MAX_PATH);
    g_alZoeyLaugh = new ArrayList(PLATFORM_MAX_PATH);
    g_alCoachLaugh = new ArrayList(PLATFORM_MAX_PATH);
    g_alEllisLaugh = new ArrayList(PLATFORM_MAX_PATH);
    g_alNickLaugh = new ArrayList(PLATFORM_MAX_PATH);
    g_alRochelleLaugh = new ArrayList(PLATFORM_MAX_PATH);
...
public int GetSurvivorType(int client)
{
