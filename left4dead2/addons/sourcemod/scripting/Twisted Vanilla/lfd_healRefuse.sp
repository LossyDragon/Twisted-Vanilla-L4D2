...
public Plugin myinfo =
{
	name = "Heal Refuse",
	author = "bullet28",
	description = "Allows you to deny someones first aid kit healing by pressing Jump",
	version = "2",
	url = ""
}
...
public Action eventHealBegin(Event event, const char[] name, bool dontBroadcast) {
	...
	PrintHintText(target, "You can refuse healing by pressing Jump button");
}
...
public Action OnPlayerRunCmd(int client, int &buttons) {
	if (bIsBeingHealing[client] && buttons & IN_JUMP && isPlayerAliveSurvivor(client)) {
