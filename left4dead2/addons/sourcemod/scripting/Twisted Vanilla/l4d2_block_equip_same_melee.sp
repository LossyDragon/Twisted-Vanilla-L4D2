...
// Defines
// ====================================================================================================
#define CLASSNAME_WEAPON_MELEE        "weapon_melee"
...
public Action OnWeaponCanUse(int client, int weapon)
{
    ...
    char pickupWeaponClass[13];
    GetEntityClassname(weapon, pickupWeaponClass, sizeof(pickupWeaponClass));

    if (!StrEqual(pickupWeaponClass, CLASSNAME_WEAPON_MELEE))
        return Plugin_Continue;
    ...
    char entityClassname[13];
    GetEntityClassname(entity, entityClassname, sizeof(entityClassname));

    if (!StrEqual(entityClassname, CLASSNAME_WEAPON_MELEE))
        return Plugin_Continue;
